...
Game Goal: Player competes against enemies to achieve the max score first. The player can receive points by killing enemies but the enemies can also receive points by killing the player. The player can kill enemies using a gun but must be wary of being overrun by increasingly difficult waves of enemies.
Goals per person: 
